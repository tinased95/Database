...
CREATE TABLE `companyaddress` (
  ...
  `CompanyStreet` varchar(45) DEFAULT NULL,
  `CompanyPelak` varchar(45) DEFAULT NULL,
...
INSERT INTO `companyaddress` VALUES (1001,'Tehran','Enghelab','21'),(1002,'Tehran','Azadi','43'),(1003,'Esfehan','Taleghani','8'),(1004,'Mashhad','Bahar','19'),(1005,'Tehran','Arjantin','5');
