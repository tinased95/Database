...
--
-- Table structure for table `digitalutility`
--
...
--
-- Dumping data for table `digitalutility`
--

LOCK TABLES `digitalutility` WRITE;
/*!40000 ALTER TABLE `digitalutility` DISABLE KEYS */;
INSERT INTO `digitalutility` VALUES (14),(18);
/*!40000 ALTER TABLE `digitalutility` ENABLE KEYS */;
UNLOCK TABLES;
